    ...
    return (
        <div className='page'>
            ...
            <h4>Если вы предпочитаете писать код в вашем редакторе</h4>
                ...
                <p>Если вы хотите делать так, здесь есть следующие шаги:</p>
                <p>1. Удостоверьтесь что у вас установилена новейшая версия Node.js</p>
                <p>2. Следуйте инструкции по созданию нового проекта</p>
                <div className='code'>
                    <code>npm install -g create-react-app<br/>create-react-app my-app</code>
                </div>
                <p>3. Удалите все файлы в папке scr/ в новом проекте (не удаляйте саму папку)</p>
        </div>
    )
}
